                                                            ...
                                                            <tr>
                                                                <td class="button__td "
                                                                    ...
                                                                    <a href="" class="button__a" target="_blank"
                                                                       style="border-radius: 4px; color: #FFFFFF; display: block; font-family: sans-serif; font-size: 18px; font-weight: bold; mso-height-rule: exactly; line-height: 1.1; padding: 14px 18px; text-decoration: none; text-transform: none; border: 1px solid #316FEA;"> How
                                                                        Twist can help your team  </a>
                                                                    <![endif]--> <!-- [if !mso]><!--> <a
                                                                            class="button__a"
